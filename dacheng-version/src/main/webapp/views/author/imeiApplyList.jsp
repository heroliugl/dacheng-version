            ...
            <div class="box-body">
              <div class="btn-group" style="width: 100%; margin-bottom: 10px;">
                <button type="button" id="color-chooser-btn" class="btn btn-info btn-block dropdown-toggle" data-toggle="dropdown">Color <span class="caret"></span></button>
                 ...
                 <a href="#/product/add" class="btn btn-primary ">添加新Imei</a>
              </div>
              /btn-group
            </div>
          </div>
          ...
          <!--   <div class="box-header">
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <tr ng-repeat="n in imeiApplys track by $index" ng-cloak>
					<td>{{$index+1}}</td>
					<td>{{n.applyId}}</td>
					<td>{{n.imei}}</td>
					<td>{{n.applyName}}</td>
					<td>{{n.applyTime | date:'yyyy-MM-dd'}}</td>
					<td>{{n.applyNum}}</td>
					<td>{{n.applyNum - n.usedNum}}</td>
					<td>{{n.endTime | date:'yyyy-MM-dd HH:mm:ss'}}</td>
